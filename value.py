...
enemyVX=[0]*nE
enemyVY=[0]*nE
enemyWidth=[playerWidth,playerWidth,playerWidth,playerWidth,playerWidth,playerWidth,playerWidth,playerWidth,playerWidth,playerWidth*4]
enemyHeight=[playerHeight,playerHeight,playerHeight,playerHeight,playerHeight,playerHeight,playerHeight,playerHeight,playerHeight,playerHeight*4]
enemyIsAtack=[0]*nE
enemyWalkPause=[1]*nE
enemyWalkTime=[0]*nE
